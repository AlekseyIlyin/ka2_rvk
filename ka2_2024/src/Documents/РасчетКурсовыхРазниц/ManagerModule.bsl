...
Функция ТекстЗапросаКурсовыеРазницыРасчетыПоФинансовымИнструментам()
	...
	|	ЛЕВОЕ СОЕДИНЕНИЕ ДоговораЗаДеньПоДокументамОплаты КАК ОборотыЗаДень
	|		ПО Движения.АналитикаУчетаПоПартнерам = ОборотыЗаДень.АналитикаУчетаПоПартнерам
	|		И Движения.Договор = ОборотыЗаДень.Договор
	|		И Движения.ТипСуммы = ОборотыЗаДень.ТипСуммы
	|ГДЕ
