...
Функция СостояниеОтправки()
	...
	Если НаборЗаписей.Количество() > 0 Тогда
		...
		ВыплатаТипУведомления = Запись.ВыплатаТипУведомления;
	Иначе
		Состояние = ВариантыСостояний.ПустаяСсылка();
		ВыплатаТипУведомления = 0;
	КонецЕсли;
