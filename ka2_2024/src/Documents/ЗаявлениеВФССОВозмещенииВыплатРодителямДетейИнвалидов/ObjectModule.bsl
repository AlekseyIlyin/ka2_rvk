...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого СтрокаТаблицы Из Оплаты Цикл
		...
		Если ОтправлятьЧерезСЭДО Тогда
			ПроверкиБЗК.ПроверитьЗаполнениеРеквизитаСтрокиТаблицы(Отказ, ЭтотОбъект, "Оплаты", СтрокаТаблицы, "ВидЗанятости");
			ПроверкиБЗК.ПроверитьЗаполнениеРеквизитаСтрокиТаблицы(Отказ, ЭтотОбъект, "Оплаты", СтрокаТаблицы, "СправкаСерия");
			ПроверкиБЗК.ПроверитьЗаполнениеРеквизитаСтрокиТаблицы(Отказ, ЭтотОбъект, "Оплаты", СтрокаТаблицы, "СправкаНомер");
			ПроверкиБЗК.ПроверитьЗаполнениеРеквизитаСтрокиТаблицы(Отказ, ЭтотОбъект, "Оплаты", СтрокаТаблицы, "СправкаДатаВыдачи");
			ПроверкиБЗК.ПроверитьЗаполнениеРеквизитаСтрокиТаблицы(Отказ, ЭтотОбъект, "Оплаты", СтрокаТаблицы, "СправкаДатаУстановления");
		КонецЕсли;
	КонецЦикла;
