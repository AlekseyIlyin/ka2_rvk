...
Функция ДанныеДляПечатиЗаявленияОНазначенииПособияПоУходуЗаРебенком(МассивСсылок)
	...
	|	ДанныеДокументов.УполномоченныйПредставитель КАК УполномоченныйПредставитель,
	|	ДанныеДокументов.УполномоченныйПредставительДолжность КАК УполномоченныйПредставительДолжность,
	...
	|
	|ВЫБРАТЬ
	|	ДанныеДокументов.УполномоченныйПредставитель,
	|	ДанныеДокументов.ДатаНачалаСобытия
	|ИЗ
	|	ВТДанныеДокументов КАК ДанныеДокументов
	|ГДЕ
	|	ДанныеДокументов.УполномоченныйПредставитель <> ЗНАЧЕНИЕ(Справочник.ФизическиеЛица.ПустаяСсылка)";
	...
	|		ПО ДанныеДокументов.УполномоченныйПредставитель = ПредставительКадровыеДанные.ФизическоеЛицо
