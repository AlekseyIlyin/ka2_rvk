...
Процедура РаспределитьТабличныеЧасти(Запрос)
	...
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(ДебиторскаяЗадолженность.СуммаВзаиморасчетов * (КурсыВалют.КурсЧислитель / КурсыВалют.КурсЗнаменатель) / (КурсВалютыУпр.КурсЧислитель / КурсВалютыУпр.КурсЗнаменатель) КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК СуммаУпр,
	|	ВЫБОР
	|		КОГДА &СуммыРеглУпрУказаныВДокументе
	|			ТОГДА ДебиторскаяЗадолженность.СуммаРегл
	...
	|			ТОГДА ДебиторскаяЗадолженность.СуммаВзаиморасчетов
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(ДебиторскаяЗадолженность.СуммаВзаиморасчетов * КурсыВалют.КурсЧислитель / КурсыВалют.КурсЗнаменатель КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК СуммаРегл,
	...
	|		ПО ДебиторскаяЗадолженность.ВалютаВзаиморасчетов = КурсыВалют.Валюта
	...
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(КредиторскаяЗадолженность.СуммаВзаиморасчетов * (КурсыВалют.КурсЧислитель / КурсыВалют.КурсЗнаменатель) / (КурсВалютыУпр.КурсЧислитель / КурсВалютыУпр.КурсЗнаменатель) КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК СуммаУпр,
	|	ВЫБОР
	|		КОГДА &СуммыРеглУпрУказаныВДокументе
	|			ТОГДА КредиторскаяЗадолженность.СуммаРегл
	...
	|			ТОГДА КредиторскаяЗадолженность.СуммаВзаиморасчетов
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(КредиторскаяЗадолженность.СуммаВзаиморасчетов * КурсыВалют.КурсЧислитель / КурсыВалют.КурсЗнаменатель КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК СуммаРегл,
	...
	|		ПО КурсВалютыУпр.БазоваяВалюта = &ВалютаРегламентированногоУчета
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОтносительныеКурсыВалют.СрезПоследних(&ДатаДокумента, ) КАК КурсыВалют
	|		ПО КредиторскаяЗадолженность.ВалютаВзаиморасчетов = КурсыВалют.Валюта
	|		И КурсыВалют.БазоваяВалюта = &ВалютаРегламентированногоУчета
	|ГДЕ
