	...
	Если СтруктураВидовУчета.ОстальныеВидыУчета Тогда
		...
		Если РеквизитыДляПроведения.ИсчисленныйНалогПереданДляУдержанияВНалоговыеОрганы Тогда
			...
			Иначе
				...
				ПараметрыОтбора = Новый Структура("НачислениеУдержание", Перечисления.ВидыОсобыхНачисленийИУдержаний.НДФЛ);
				НалогПереданныйВНалоговыйОрган = Движения.НачисленияУдержанияПоСотрудникам.Выгрузить().Скопировать(ПараметрыОтбора);
