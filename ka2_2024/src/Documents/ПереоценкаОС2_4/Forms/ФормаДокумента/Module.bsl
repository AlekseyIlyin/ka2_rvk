...
Процедура НастроитьЗависимыеЭлементыФормыНаСервере(Знач ИзмененныеРеквизиты = "")
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("Организация") 
		...
		Если СлужебныеПараметрыФормы.ВедетсяРегламентированныйУчетВНА Тогда
			...
			Элементы.ОССтоимостьУУ.Заголовок = СтрШаблон(НСтр("ru = 'Сумма упр. (%1)'"), Строка(СлужебныеПараметрыФормы.ВалютаУпр));
			Элементы.ОССтоимостьБУ.Заголовок = СтрШаблон(НСтр("ru = 'Сумма регл. %1'"), Строка(ВалютаРеглПредставление));
		...
		Иначе
			...
			Иначе
				...
				Элементы.ОССтоимостьУУ.Заголовок = СтрШаблон(НСтр("ru = 'Сумма (%1)'"), Строка(СлужебныеПараметрыФормы.ВалютаУпр));
				Элементы.ОССтоимостьБУ.Заголовок = СтрШаблон(НСтр("ru = 'Сумма %1'"), Строка(ВалютаРеглПредставление));
