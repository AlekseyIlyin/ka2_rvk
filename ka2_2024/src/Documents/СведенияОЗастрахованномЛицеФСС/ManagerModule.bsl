...
Функция ОписаниеПодписейДокумента() Экспорт
	...
	ОписаниеПодписиРуководитель.ФизическоеЛицо = "УполномоченныйПредставитель";
	ОписаниеПодписиРуководитель.Должность = "УполномоченныйПредставительДолжность";
	ОписаниеПодписиРуководитель.ОснованиеПодписи = "УполномоченныйПредставительОснованиеПодписи";
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы") Тогда
		СтрокаРолей = "ПредставительСФР";
	Иначе
		СтрокаРолей = "Руководитель";
	КонецЕсли;
	ПереопределяемыеИмена.Вставить(СтрокаРолей, ОписаниеПодписиРуководитель);
