...
Процедура ДанныеВРеквизит()
	...
	Если ТаблицаСотрудников.Количество() > 0 Тогда
		...
		ОтражениеЗарплатыВБухучетеРасширенный.БухучетНачисленийДанныеВРеквизит(ЭтаФорма, ОписанияТаблиц, ИсключаемыеРегистраторы(), ТаблицаСотрудников);
...
Процедура ЗаполнитьБухучетДействующихНачислений(ЗаполнитьБухучетНачислений = Истина, ЗаполнитьБухучетЛьгот = Истина, БухучетПрежнихНачислений = Неопределено)
	...
	КонецЕсли;
	УстановитьПривилегированныйРежим(Истина);
	ОтражениеЗарплатыВБухучетеРасширенный.БухучетДействующихНачисленийВРеквизиты(ЭтаФорма, ОписанияТаблиц, ИсключаемыеРегистраторы(), ТаблицаСотрудников, БухучетПрежнихНачислений);
