...
Функция ЗначенияПоказателейПлановыхНачислений(РеквизитыДляПроведения)
	...
	Иначе	
		...
		Если ПолучитьФункциональнуюОпцию("ИндексироватьСреднийЗаработокЧастично") Тогда 
			ПоказательСреднийЗаработокИндексируемый = ЗначенияПоказателейПлановыхНачислений.Добавить();
			ПоказательСреднийЗаработокИндексируемый.Значение = РеквизитыДляПроведения.СреднийЗаработокИндексируемый;
			ПоказательСреднийЗаработокИндексируемый.Показатель = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.СреднийЗаработокИндексируемый");
			ПоказательСреднийЗаработокНеиндексируемый = ЗначенияПоказателейПлановыхНачислений.Добавить();
			ПоказательСреднийЗаработокНеиндексируемый.Значение = РеквизитыДляПроведения.СреднийЗаработокНеиндексируемый;
			ПоказательСреднийЗаработокНеиндексируемый.Показатель = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.СреднийЗаработокНеиндексируемый");
		КонецЕсли;
	КонецЕсли;
