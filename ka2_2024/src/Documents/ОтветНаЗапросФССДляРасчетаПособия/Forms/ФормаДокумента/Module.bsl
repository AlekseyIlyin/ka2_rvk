...
Процедура ОбновитьЭлементыГруппыДанныеДляРасчета(Видимость, Представление)
	...
	Элементы.ПервыйРасчетныйГодВидЗаработка.Видимость   = Особенности.Версия_2_34 И Не Объект.Перерасчет;
	Элементы.ВторойРасчетныйГодВидЗаработка.Видимость   = Особенности.Версия_2_34 И Не Объект.Перерасчет;
