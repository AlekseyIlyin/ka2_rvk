...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Основание, Настройки, ДеревоДанных, Описание, Отказ) Экспорт
	...
	Пока ВыборкаТоваров.Следующий() Цикл
		...
		НоваяСтрока.ЕдиницаИзмеренияКод = СокрЛП(ВыборкаТоваров.ЕдиницаИзмеренияКод);
		НоваяСтрока.ЕдиницаИзмеренияНаименование = ВыборкаТоваров.ЕдиницаИзмеренияНаименование;
		НоваяСтрока.Количество = ВыборкаТоваров.КоличествоУпаковок;
		...
		НоваяСтрока.НалоговаяСтавка = ИнтеграцияЭДОПовтИсп.СтавкаНДСПеречисление(Перечисления.СтавкиНДС.БезНДС);
	...
	ЭлектронноеВзаимодействиеИСМП.ЗагрузитьСтруктуруВГруппуДерева(ДеревоДанных, СуммаНалога, "ТаблицаСчетаФактуры.ВсегоКОплате.СуммаНалога");
...
Функция ПолучитьДанныеДляЭД(ДокументСсылка) Экспорт
	...
	Запрос.Текст =
		...
		|	ПеремещениеМеждуМОДИСМПТовары.Характеристика.Наименование                КАК ХарактеристикаНаименование,
		|	ПеремещениеМеждуМОДИСМПТовары.Номенклатура.ЕдиницаИзмерения              КАК ЕдиницаИзмерения,
		|	ПеремещениеМеждуМОДИСМПТовары.Номенклатура.ЕдиницаИзмерения.Наименование КАК ЕдиницаИзмеренияНаименование,
		|	ПеремещениеМеждуМОДИСМПТовары.Номенклатура.ЕдиницаИзмерения.Код          КАК ЕдиницаИзмеренияКод,
