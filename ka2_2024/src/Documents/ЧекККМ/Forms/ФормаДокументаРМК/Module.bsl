...
Процедура ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение)
	...
	Если ИспользоватьСкладскиеПомещения Тогда
		СтруктураДействий.Вставить("ЗаполнитьПомещение");
	КонецЕсли;
...
Процедура ТоварыПриОкончанииРедактированияЛокализация(
	...
	Если ОбщегоНазначенияИСВызовСервера.ВидыПродукцииИспользующиеВскрытыеПотребительскихУпаковок(,, Ложь).Количество()
