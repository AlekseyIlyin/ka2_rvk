...
Процедура ДобавитьВеткуПрочее(КорневойУровень, ФлагиУчета)
	...
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ПрекращениеСтраховыеВзносы);
...
&НаСервере
Процедура ДобавитьВеткуМониторингЗанятости(КорневойУровень, ФлагиУчета)
	Если ЗначениеЗаполнено(ФлагиУчета) И ФлагиУчета.СервисЭлектронныхТрудовыхКнижек Тогда
		Возврат;
	КонецЕсли;
...
Процедура СформироватьДерево()
	...
	ДобавитьВеткуМониторингЗанятости(КорневойУровень, ФлагиУчета);
