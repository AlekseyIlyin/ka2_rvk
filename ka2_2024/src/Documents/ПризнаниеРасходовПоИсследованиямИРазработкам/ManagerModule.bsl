...
Функция ТекстЗапросаТаблицаДокументыПоНМА(ТекстыЗапроса, Регистры)
	...
	|ПОМЕСТИТЬ ДокументыПоНМААвтонумерация
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ДокументыПоНМААвтонумерация.НомерЗаписи-1 КАК НомерЗаписи,
	|	ДокументыПоНМААвтонумерация.Дата КАК Дата,
	|	ДокументыПоНМААвтонумерация.Ссылка КАК Ссылка,
	|	ДокументыПоНМААвтонумерация.Организация КАК Организация,
	|	ДокументыПоНМААвтонумерация.Подразделение КАК Подразделение,
	|	ДокументыПоНМААвтонумерация.ТипСсылки КАК ТипСсылки,
	|	ДокументыПоНМААвтонумерация.ХозяйственнаяОперация КАК ХозяйственнаяОперация,
	|	ДокументыПоНМААвтонумерация.Проведен КАК Проведен,
	|	ДокументыПоНМААвтонумерация.ОтражатьВРеглУчете КАК ОтражатьВРеглУчете,
	|	ДокументыПоНМААвтонумерация.ОтражатьВУпрУчете КАК ОтражатьВУпрУчете,
	|	ДокументыПоНМААвтонумерация.НематериальныйАктив КАК НематериальныйАктив
	|ИЗ
	|	ДокументыПоНМААвтонумерация КАК ДокументыПоНМААвтонумерация";
