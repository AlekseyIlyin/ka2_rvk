...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Расчет по страховым взносам"
		И ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2025Кв1" Тогда
		ПоказатьПредупреждение(, НСтр(
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Акцизы на алкогольную продукцию"
		И ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2025Кв1" Тогда
		ПоказатьПредупреждение(, НСтр(
		"ru='Печать со штрихкодом PDF417 формы
