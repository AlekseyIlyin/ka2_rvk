...
Процедура ПрочитатьНастройки1СПерсонал()
	...
	НастройкаДоступна = Интеграция1СПерсонал.ДоступноИзменениеИспользованияИнтеграции();
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
	...
	НастройкаДоступна = Не ИнтеграцияУправлениеПерсоналом.Используется1СПерсонал();
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
