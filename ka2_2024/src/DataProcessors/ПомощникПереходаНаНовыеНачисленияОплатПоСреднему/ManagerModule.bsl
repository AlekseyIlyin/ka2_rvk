...
Процедура ПоместитьВидРасчетаВАрхив(ВидРасчета)
	...
	ВидРасчетаОбъект.Наименование = СтрШаблон(НСтр("ru = '%1 (до 2025)'"), СокрЛП(ВидРасчетаОбъект.Наименование));
	КраткоеНаименование = СокрЛП(ВидРасчетаОбъект.КраткоеНаименование);
	Если КраткоеНаименование <> "" Тогда
		ВидРасчетаОбъект.КраткоеНаименование = СтрШаблон(НСтр("ru = '%1 (до 2025)'"), КраткоеНаименование);
	КонецЕсли;
...
Процедура СоздатьДополнительныйВидРасчета(ОсновнойВидРасчета, ПрежнийВидРасчета, СозданиеДолиРК, ДополнительныеВидыРасчета)
	...
	Описание.Наименование = СтрШаблон(НСтр("ru = '%1 %2'"), СокрЛП(ЗначенияСвойствОсновногоВидаРасчета.Наименование), Постфикс);
