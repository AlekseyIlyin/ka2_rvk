...
Функция РазбитьСтрокиПоОграничениям(РазмещениеТоваровВЯчейках, МаксимальныйОбъем, МаксимальныйВес)
	...
	Для Каждого ОписаниеРазмещения Из РазмещениеТоваровВЯчейках Цикл
		...
		МаксимальноеКоличествоПоОбъему = Цел(МаксимальныйОбъем / ОписаниеРазмещения.ОбъемУпаковки);
		МаксимальноеКоличествоПоВесу = Цел(МаксимальныйВес / ОписаниеРазмещения.ВесУпаковки);
