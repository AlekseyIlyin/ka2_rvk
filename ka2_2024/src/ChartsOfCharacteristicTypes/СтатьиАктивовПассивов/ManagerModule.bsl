...
//-- НЕ УТ
	...
	ОписаниеТипа = Новый ОписаниеТипов(МассивТипов);
	Элемент.ТипЗначения = ОписаниеТипа;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Расчеты с филиалами по выделенному имуществу'", КодыЯзыков); // @НСтр-2
	...
	ОписаниеТипа = Новый ОписаниеТипов(МассивТипов);
	Элемент.ТипЗначения = ОписаниеТипа;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Реализация ОС без перехода права собственности'", КодыЯзыков); // @НСтр-2
...
Процедура ЗаполнитьНастройкиПредопределенныхЭлементов() Экспорт
	...
	АктивыПассивы.Добавить(ПланыВидовХарактеристик.СтатьиАктивовПассивов.ИнвестицииВАренду);
	//-- НЕ УТ
