	...
	Если ВсеФизлица.Количество() > 0 Тогда
		...
		Для каждого СтрокаРезультата Из ВсеФизлица Цикл
			...
			Если СтрокаРезультата.ФизическоеЛицо <> Неопределено И СтрокаРезультата.П000030001001 <> "1" Тогда
				КодКатегорииНулевыхДоходов = КодКатегорииНулевыхДоходовПоКатегорииЗЛ(СтрокаРезультата.КатегорияЗастрахованныхЛиц, ОкончаниеПериода);
...
Функция КодКатегорииНулевыхДоходовПоКатегорииЗЛ(КатегорияЗастрахованныхЛиц, ОкончаниеПериода)
	...
	Иначе
		...
		КатегорияНулевыхДоходов = КатегорииНулевыхДоходов[КатегорияЗастрахованныхЛиц];
		КатегорияНулевыхДоходов = ?(КатегорияНулевыхДоходов = Неопределено, КатегорияЗастрахованныхЛиц, КатегорияНулевыхДоходов);
		Возврат Перечисления.КатегорииЗастрахованныхЛицДляПФР.КодКатегорииДляОтчета(КатегорияНулевыхДоходов);
	КонецЕсли;	
