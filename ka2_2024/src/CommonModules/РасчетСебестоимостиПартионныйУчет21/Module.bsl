...
Функция ПартионныйУчетВерсии22НельзяПонизитьДоВерсии21(ЕстьДвиженияПУ22) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.КодПричины = 2 Тогда
			ТекстПредупреждения = ТекстПредупреждения + "
				|    - " + НСтр("ru = 'используется управление производством версии 2.2'", ОбщегоНазначения.КодОсновногоЯзыка());
		//-- НЕ УТ
		...
		ИначеЕсли Выборка.КодПричины = 4 Тогда
			ТекстПредупреждения = ТекстПредупреждения + "
				|    - " + НСтр("ru = 'используется учет внеоборотных активов версии 2.4'", ОбщегоНазначения.КодОсновногоЯзыка());
		//-- НЕ УТ
		Иначе
