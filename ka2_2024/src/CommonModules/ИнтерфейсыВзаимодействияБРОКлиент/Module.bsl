...
Процедура ПриНачалеПодписания(Организации, Файл, Полномочия, Оповещение, СтандартнаяОбработка) Экспорт
	...
	ПараметрыОтбораROSSTAT_STAT_001 = Новый Структура("Код", "ROSSTAT_STAT_001");
	...
	Если Полномочия.НайтиСтроки(ПараметрыОтбораROSSTAT_STAT_001).Количество() <> 0
		ИЛИ Полномочия.НайтиСтроки(ПараметрыОтбораFTS_10001).Количество() <> 0
