...
Процедура НачисленияОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.Отбор.Свойство("ОграничиватьВыборОсновныхВидовРасчетаОплатыПоСреднему") Тогда
		...
		Если Не ПустаяСтрока(ТекстЗапроса) Тогда
			КатегорииОплатыДолейРКиСН = Новый Массив;
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСреднемЗаработке);
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСреднемЗаработке);
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСДС);
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСДС);
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСДД);
			КатегорииОплатыДолейРКиСН.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСДД);
			...
			Запрос.УстановитьПараметр("КатегорииОплатыДолейРКиСН", КатегорииОплатыДолейРКиСН);
