...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета) Экспорт
	...
	РасшифровкаКодовОшибок = Новый Соответствие;
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Не заполнено направление деятельности в движениях документа ""Резервы отпусков"" по регистру ""Партии прочих расходов"".'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.ПерепровестиДокументыПоОтдельнымРегистрамНакопления(
		...
		Запрос,
		РасшифровкаКодовОшибок,
		НСтр("ru = 'некорректное заполнение направления деятельности в регистре ""Партии прочих расходов""'", ОбщегоНазначения.КодОсновногоЯзыка()));
