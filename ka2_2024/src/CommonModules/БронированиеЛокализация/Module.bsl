...
#Область ПокупкаБилета // (Дт 76.14 :: Кт 60, 71, 76)
	...
	|
	|	-РасчетыСПеревозчиками.СуммаРегл КАК Сумма,
	|	-РасчетыСПеревозчиками.СуммаУпр КАК СуммаУУ,
	|
	...
	|	
	|	-РасчетыСПеревозчиками.Сумма КАК ВалютнаяСуммаДт,
	|	0 КАК КоличествоДт,
	|	0 КАК СуммаНУДт,
	|	0 КАК СуммаПРДт,
	|	0 КАК СуммаВРДт,
	...
	|
	|	-РасчетыСПеревозчиками.Сумма КАК ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|	0 КАК СуммаНУКт,
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	...
	|			ИЛИ РасчетыСПеревозчиками.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратБронированияПодотчетногоЛица)
