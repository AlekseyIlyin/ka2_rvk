...
Процедура СоздатьВТДосрочноеНазначениеПенсииДляСЗВ_СТАЖ(МенеджерВременныхТаблиц, Организация, Год, ЗаписиОСтаже) Экспорт
	...
	СоздатьВТДосрочноеНазначениеПенсии(Запрос, Организация, Истина);
...
Процедура СоздатьВТДосрочноеНазначениеПенсии(Запрос, Организация, ИспользуетсяФильтр = Ложь)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульОхранаТруда.СоздатьВТДосрочноеНазначениеПенсии(Запрос, Организация, СтандартнаяОбработка, ИспользуетсяФильтр);
