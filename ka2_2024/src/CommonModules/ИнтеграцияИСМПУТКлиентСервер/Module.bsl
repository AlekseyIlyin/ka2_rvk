...
Процедура КомандыМаркировкиТоваровИСМП(Команды) Экспорт 
	...
	//-- Устарело_Переработка24
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды,"ПоступлениеТоваровОтХранителя",НСтр("ru = 'Поступление от переработчика 2.5'"), "ИспользоватьПроизводствоНаСтороне2_5");
...
Процедура КомандыЗаказНаЭмиссиюКодовМаркировкиСУЗ(Команды) Экспорт 
	...
	//++ Устарело_Переработка24
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(
		Команды, "ЗаказПереработчику", НСтр("ru = 'Заказ переработчику (2.4)'"), "ИспользоватьПроизводствоНаСтороне");
	//-- Устарело_Переработка24
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(
		Команды, "ЗаказПереработчику2_5", НСтр("ru = 'Заказ переработчику'"), "ИспользоватьЗаказыПереработчикам2_5");
