...
// не учитываются как контролируемые, если сделки совершены с участниками спец.режимов (ЕНВД и ЕСХН)
//
//	Возвращаемое значение:
//		Дата - дата с которой будет вестись учет спецрежимов для невзаимозависимых посредников.
//
...
Процедура ЗаполнитьШтрихкод(Штрихкод)
	...
	Штрихкод.Картинка = ГенерацияШтрихкода.ИзображениеШтрихкода(ПараметрыШтрихкода).Картинка;
