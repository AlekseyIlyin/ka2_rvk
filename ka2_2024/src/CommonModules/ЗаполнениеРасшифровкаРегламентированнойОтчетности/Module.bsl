...
//  ДополнительныеПараметры - Структура - см. НалогНаПрибыльДекларация.НовыйУсловиеПолученияДанныхИнформационнойБазы 
// 
// Возвращаемое значение:
...
Функция НовыйНастройкиОтчетаПоРегиструБухгалтерии(ВидОтчета, Организация, НачалоПериода, КонецПериода, Счет, ОписаниеСумм,
	...
	ИначеЕсли ВидОтчета = "ОборотыСчета" Тогда
		...
		ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("ПоСубсчетам",          Истина);
	ИначеЕсли ВидОтчета = "РегистрыНалоговогоУчета" Тогда
		ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("ВариантНалогообложенияПрибыли", 
			ДополнительныеПараметры.ВариантНалогообложенияПрибыли);	
		ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("КлючВарианта", 
			ДополнительныеПараметры.КлючВарианта);			
	КонецЕсли;
