...
Функция ТекстЗапросаТаблицаПервоначальныеСведенияНМА(Запрос, ТекстыЗапроса) Экспорт
	...
	|			ТОГДА ЕСТЬNULL(РасчетСтоимости.СтоимостьПР + РасчетСтоимости.СтоимостьПРЦФ, ДанныеДокумента.ПервоначальнаяСтоимостьПР)
	...
	|		КОГДА ВтПорядокПринятияКУчету.ПринятьКУчетуБУ
	|				ИЛИ ВтПорядокПринятияКУчету.ПринятьКУчетуНУ 
	|			ТОГДА ЕСТЬNULL(РасчетСтоимости.СтоимостьВР + РасчетСтоимости.СтоимостьВРЦФ, ДанныеДокумента.ПервоначальнаяСтоимостьВР)
