...
#КонецОбласти
	...
	ТекстыОтражения.Добавить(ТекстОтправительПереносПретензииНаРасчетыНовыеВзаиморасчеты());
...
Функция ТекстОтправительПереносПретензииНаРасчетыНовыеВзаиморасчеты()
	...
	|	Расчеты.Сумма КАК ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|	Расчеты.СуммаРегл КАК СуммаНУКт,
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	ВЫБОР
