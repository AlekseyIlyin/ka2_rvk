...
//
Функция ВыполнитьОперацию(НачалоПериода, КонецПериода, СписокОрганизаций, НомерДоРасчета, МенеджерВременныхТаблиц, ИмяРегистраЗаданий, ИдентификаторРасчета, УдалитьЗадания = Истина) Экспорт
	...
	ОчередьЗаданийКРасчету = СоздатьОчередьЗаданий(
		НачалоПериода, КонецПериода, СписокОрганизаций, НомерДоРасчета, МенеджерВременныхТаблиц, ИмяРегистраЗаданий, УдалитьЗадания);
...
Процедура СформироватьЗадания(Документ, ДанныеТаблиц) Экспорт
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьВнеоборотныеАктивы2_4")
		ИЛИ ДвиженияЗаписываютсяПриВыполненииОперации(Документ)
	...
	Если Документ <> Неопределено
		И НЕ РасчетСтоимостиВНА.ДвиженияЗаписываютсяПриВыполненииОперации(Документ) Тогда
	...
	Запрос.УстановитьПараметр("ДвиженияЗаписываютсяПриОтложенномФормированииДвижений", ДвиженияЗаписываютсяПриВыполненииОперации(Документ));
...
Процедура ЗарегистрироватьОшибки(ПараметрыВыполнения)
	...
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияСтоимости) КАК ОтражениеУвеличенияСтоимости,
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияСтоимости) КАК ОтражениеУменьшенияСтоимости,
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУвеличенияАмортизации) КАК ОтражениеУвеличенияАмортизации,
	|	МАКСИМУМ(ТаблицаВНА.ОтражениеУменьшенияАмортизации) КАК ОтражениеУменьшенияАмортизации
	|
	|ИЗ
	|	(ВЫБРАТЬ
	|		ТаблицаВНА.Ссылка КАК Ссылка,
	|		ТаблицаВНА.Организация КАК Организация,
	|		ТаблицаВНА.ОбъектУчета КАК ОбъектУчета,
	|		ИСТИНА КАК ОтражениеУвеличенияСтоимости,	
	|		ЛОЖЬ КАК ОтражениеУменьшенияСтоимости,
	|		ЛОЖЬ КАК ОтражениеУвеличенияАмортизации,
	|		ЛОЖЬ КАК ОтражениеУменьшенияАмортизации
	|
	|	ИЗ
	|		ТаблицаВНА КАК ТаблицаВНА
	|
	|	ГДЕ
	|		ТИПЗНАЧЕНИЯ(ТаблицаВНА.Ссылка) = ТИП(Документ.КорректировкаСтоимостиИАмортизацииОС)
	|		И ТаблицаВНА.КорректировкаСтоимости
	...
	|					РегистрНакопления.СтоимостьОС КАК СтоимостьОС
	|				ГДЕ
	|					СтоимостьОС.Регистратор = ТаблицаВНА.Ссылка
	|					И СтоимостьОС.ОсновноеСредство = ТаблицаВНА.ОбъектУчета
	|					И СтоимостьОС.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеСтоимостиОС)))
	|				
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	...
	|		ТаблицаВНА.Организация КАК Организация,
	|		ТаблицаВНА.ОбъектУчета КАК ОбъектУчета,
	|		ЛОЖЬ КАК ОтражениеУвеличенияСтоимости,	
	|		ИСТИНА КАК ОтражениеУменьшенияСтоимости,
	|		ЛОЖЬ КАК ОтражениеУвеличенияАмортизации,
	|		ЛОЖЬ КАК ОтражениеУменьшенияАмортизации
	|
	|	ИЗ
	...
	|					И СтоимостьОС.ОсновноеСредство = ТаблицаВНА.ОбъектУчета
	|					И СтоимостьОС.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеСтоимостиОС),
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеСтоимостиЦФОС)))
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	...
	|
	|	ГДЕ
	|		ТИПЗНАЧЕНИЯ(ТаблицаВНА.Ссылка) = ТИП(Документ.КорректировкаСтоимостиИАмортизацииНМА)
	|		И ТаблицаВНА.КорректировкаСтоимости
	|		И ТаблицаВНА.ОтражениеУвеличенияСтоимости
	|		И НЕ ИСТИНА В (
	|				ВЫБРАТЬ ПЕРВЫЕ 1
	...
	|					РегистрНакопления.СтоимостьНМА КАК СтоимостьНМА
	|				ГДЕ
	|					СтоимостьНМА.Регистратор = ТаблицаВНА.Ссылка
	|					И СтоимостьНМА.НематериальныйАктив = ТаблицаВНА.ОбъектУчета
	|					И СтоимостьНМА.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеСтоимостиНМА)))
	|				
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	...
	|					И СтоимостьНМА.НематериальныйАктив = ТаблицаВНА.ОбъектУчета
	|					И СтоимостьНМА.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеСтоимостиНМА),
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеСтоимостиЦФНМА)))
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	...
	|		ЛОЖЬ КАК ОтражениеУвеличенияСтоимости,	
	|		ЛОЖЬ КАК ОтражениеУменьшенияСтоимости,
	|		ИСТИНА КАК ОтражениеУвеличенияАмортизации,
	|		ЛОЖЬ КАК ОтражениеУменьшенияАмортизации
	|
	|	ИЗ
	|		ТаблицаВНА КАК ТаблицаВНА
	...
	|				ГДЕ
	|					АмортизацияОС.Регистратор = ТаблицаВНА.Ссылка
	|					И АмортизацияОС.ОсновноеСредство = ТаблицаВНА.ОбъектУчета
	|					И АмортизацияОС.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеНакопленнойАмортизацииОС),
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеНакопленнойАмортизацииЦФОС),
	...
	|		ЛОЖЬ КАК ОтражениеУменьшенияСтоимости,
	|		ЛОЖЬ КАК ОтражениеУвеличенияАмортизации,
	|		ИСТИНА КАК ОтражениеУменьшенияАмортизации
	|
	|	ИЗ
	|		ТаблицаВНА КАК ТаблицаВНА
	|
	...
	|					И АмортизацияОС.ОсновноеСредство = ТаблицаВНА.ОбъектУчета
	|					И АмортизацияОС.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеНакопленнойАмортизацииОС)))
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	...
	|					РегистрНакопления.АмортизацияНМА КАК АмортизацияНМА
	|				ГДЕ
	|					АмортизацияНМА.Регистратор = ТаблицаВНА.Ссылка
	|					И АмортизацияНМА.НематериальныйАктив = ТаблицаВНА.ОбъектУчета
	|					И АмортизацияНМА.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеНакопленнойАмортизацииНМА),
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УвеличениеНакопленнойАмортизацииЦФНМА),
	...
	|					И АмортизацияНМА.НематериальныйАктив = ТаблицаВНА.ОбъектУчета
	|					И АмортизацияНМА.НастройкаХозяйственнойОперации В (
	|							ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.УменьшениеНакопленнойАмортизацииНМА)))
	|
	|	) КАК ТаблицаВНА
	|
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ОтражениеУвеличенияСтоимости Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение увеличения стоимости, но для нематериального актива ""%1"" отсутствуют движения по увеличению стоимости.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение увеличения стоимости, но для основного средства ""%1"" отсутствуют движения по увеличению стоимости.'");
			КонецЕсли;
		...
		ИначеЕсли Выборка.ОтражениеУменьшенияСтоимости Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение уменьшения стоимости, но для нематериального актива ""%1"" отсутствуют движения по уменьшению стоимости.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение уменьшения стоимости, но для основного средства ""%1"" отсутствуют движения по уменьшению стоимости.'");
			КонецЕсли;
		...
		Если Выборка.ОтражениеУвеличенияАмортизации Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение увеличения амортизации, но для нематериального актива ""%1"" отсутствуют движения по увеличению амортизации.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение увеличения амортизации, но для основного средства ""%1"" отсутствуют движения по увеличению амортизации.'");
			КонецЕсли;
		...
		ИначеЕсли Выборка.ОтражениеУменьшенияАмортизации Тогда
			
			Если ЭтоНМА Тогда
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение уменьшения амортизации, но для нематериального актива ""%1"" отсутствуют движения по уменьшению амортизации.'");
			Иначе
				ОписаниеПроблемы = НСтр("ru = 'В параметрах документа выбрано отражение уменьшения амортизации, но для основного средства ""%1"" отсутствуют движения по уменьшению амортизации.'");
			КонецЕсли;
...
Процедура УдалитьЗаданияПорцииДанных(Период, ПараметрыВыполнения)
	...
	РегистрыСведений[ПараметрыВыполнения.ИмяРегистраЗаданий].ЗафиксироватьРасчет(
		Период,
		ПараметрыВыполнения.СписокОрганизаций, 
...
Функция СоздатьОчередьЗаданий(НачалоПериода, КонецПериода, СписокОрганизаций, НомерДоРасчета, МенеджерВременныхТаблиц, ИмяРегистраЗаданий, УдалитьЗадания)
	...
	ОчередьОбъектов = ВнеоборотныеАктивы.ОчередьОбъектов(
		НачалоПериода, 
		КонецПериода, 
		СписокОрганизаций, 
