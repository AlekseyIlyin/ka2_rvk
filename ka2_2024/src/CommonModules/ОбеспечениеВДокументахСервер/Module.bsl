...
Функция ПодстановкиПлановойДатыПоставки(СпособОбеспечения, НачалоЭтогоДня, ИскатьПоСрокуИсполненияЗаказа = Ложь) Экспорт
...
// Значение, если дату не удается рассчитать.
		...
		|	&СрокИсполненияЗаказаДата КАК ДатаПоставкиПоТочкеЗаказа
		|ИЗ
		|	&ВедущаяТаблица КАК ВедущаяТаблица
		|		
...
Функция ТекстИПараметрыЗапросаОбеспеченияЗаказовНаОтгрузку(ИмяВременнойТаблицы)
	...
	Подстановки = ПодстановкиПлановойДатыПоставки(Подстановки.Поле, "&НачалоТекущегоДня");
