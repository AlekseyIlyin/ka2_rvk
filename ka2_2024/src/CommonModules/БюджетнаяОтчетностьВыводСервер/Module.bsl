			...
			Иначе
				...
				Иначе
					...
					Если ПараметрыВывода.Свойство("ФорматСдвигаСумм") Тогда
						Если ИмяПоказателя = "Сумма" Или ИмяПоказателя = "Значение"
							И ПараметрыВывода.ВидыНФПОтчета.Получить(ЯчейкаОтчета.НефинансовыйПоказатель)
							= Перечисления.ВидыНефинансовыхПоказателей.Денежный Тогда
							Область.Формат = Область.Формат + ПараметрыВывода.ФорматСдвигаСумм;
