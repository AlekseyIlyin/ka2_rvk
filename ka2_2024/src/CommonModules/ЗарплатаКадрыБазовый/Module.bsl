...
Функция ПолучитьСведенияОбОрганизации(Знач Организация, Знач ДатаЗначения = Неопределено, Знач СписокПоказателей = Неопределено) Экспорт
	...
	Для Каждого Показатель Из СписокПоказателей Цикл
		...
		ИначеЕсли ИмяПоказателя = "РегНомерСФР"
			И ЗарплатаКадры.ИспользованиеРегистрационногоНомераСФР() Тогда
		...
		ИначеЕсли ИмяПоказателя = "РегНомерСФРЗаСебя"
			И ЗарплатаКадры.ИспользованиеРегистрационногоНомераСФР() Тогда
		...
		ИначеЕсли ИмяПоказателя = "РегНомерСФРГоловнойОрганизации"
			И ЗарплатаКадры.ИспользованиеРегистрационногоНомераСФР() Тогда
