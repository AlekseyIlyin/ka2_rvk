...
Функция НаступилаДатаОтменыПодтвержденияПриема() Экспорт
	...
	ЗначениеЕслиНеНайденоСобытие = ТекущаяДатаСеанса() >= ДатаОтменыПодтверждений();
	Возврат ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("ОтменаПодтвержденТребован", ЗначениеЕслиНеНайденоСобытие);
...
Функция СкорректированныеДнейДоОтвета(Требование, Знач ДнейДоОтвета) Экспорт
	...
	Если ПодтверждениеОтправилОператор(Требование) Тогда
