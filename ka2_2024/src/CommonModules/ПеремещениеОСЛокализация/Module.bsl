...
Функция ТекстЗапросаТаблицаПорядокУчетаОСБУ(ТекстыЗапроса) Экспорт
	...
	|
	|	ВЫБОР ДанныеДокумента.НачислятьАмортизацию
	|		КОГДА 0 ТОГДА ПорядокУчетаОСБУ.СтатьяРасходовАмортизационнойПремии
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК СтатьяРасходовАмортизационнойПремии,
	|
	|	ВЫБОР ДанныеДокумента.НачислятьАмортизацию
	|		КОГДА 0 ТОГДА ПорядокУчетаОСБУ.АналитикаРасходовАмортизационнойПремии
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК АналитикаРасходовАмортизационнойПремии,
	|
	|	ВЫБОР ДанныеДокумента.НачислятьАмортизацию
	|		КОГДА 0 ТОГДА ПорядокУчетаОСБУ.ПодразделениеАмортизационнойПремии
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ПодразделениеАмортизационнойПремии,
	|
	|	ВЫБОР ДанныеДокумента.НачислятьАмортизацию
	|		КОГДА 0 ТОГДА ПорядокУчетаОСБУ.НаправлениеДеятельностиАмортизационнойПремии
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
