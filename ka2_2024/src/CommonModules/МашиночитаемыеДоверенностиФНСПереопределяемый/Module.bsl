...
Процедура ПриЗаполненииРеквизитовФизическогоЛица(ФизическоеЛицо, Реквизиты) Экспорт
	...
	КонецЕсли;
	Реквизиты.ДокументНомер = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = '%1 %2'"), ДанныеФизическогоЛица.ДокументСерия, ДанныеФизическогоЛица.ДокументНомер);
