...
Функция ТипыДанныхУчетаПравилаСПроизвольнымиДанными(ПравилоФакта) Экспорт
	...
	Если Параметр_КорТипДанныхУчета <> Неопределено Тогда
		...
		Если ТипЗнч(КорТипДанныхУчета) = Тип("ПеречислениеСсылка.ТипыДанныхУчета") Тогда
			ТипыДанныхУчетаПравила.Добавить(Новый Структура("ТипДанныхУчетаРасход, ТипДанныхУчетаПриход", Перечисления.ТипыДанныхУчета.ДенежныеСредства, КорТипДанныхУчета));
		ИначеЕсли ТипЗнч(КорТипДанныхУчета) = Тип("Массив") Тогда
			Для Каждого ЭлементМассива Из КорТипДанныхУчета Цикл
				Если ТипЗнч(ЭлементМассива) = Тип("ПеречислениеСсылка.ТипыДанныхУчета") Тогда
					ТипыДанныхУчетаПравила.Добавить(Новый Структура("ТипДанныхУчетаРасход, ТипДанныхУчетаПриход", Перечисления.ТипыДанныхУчета.ДенежныеСредства, ЭлементМассива));
				КонецЕсли;
			КонецЦикла;
		КонецЕсли;
	КонецЕсли;
