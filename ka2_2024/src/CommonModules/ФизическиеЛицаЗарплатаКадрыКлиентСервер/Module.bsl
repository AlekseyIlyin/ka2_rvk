...
// Функция определяет пол физлица по его фамилии, имени и отчетсву.
// Параметр:
// 		ОбъектСЧастямиФИО - объект содержащий поля (реквизиты, ресурсы, свойства ...) Фамимлия, Имя Отчкество.
//
