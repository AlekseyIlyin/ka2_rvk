...
// Устарела. Следует использовать ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьСтрокуТЧ и 
...
// Устарела. Следует использовать ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ.
...
// Устарела. Следует использовать ПакетнаяОбработкаТабличнойЧастиСервер.КлючЗаполненияСлужебныхРеквизитовПоддерживается.
...
Функция МетодыКВыполнению(СтруктураДействий)
	...
	Соответствие.Добавить("ПересчитатьКоличествоУпаковокФактПоУпаковкам",				"ОбработкаТабличнойЧастиКлиентСервер.ПересчитатьКоличествоУпаковокФактПоУпаковкамВСтрокеТЧ");
