...
Функция ЗагрузитьНастройкиРасшифровки(Параметры, КомпоновщикНастроек, СхемаКомпоновкиДанных, ДанныеРасшифровки) Экспорт
	...
	Иначе
		РасшифровкаКомпановки = ПолучитьИзВременногоХранилища(Параметры.Расшифровка.Данные);
		ОбработкаРасшифровки =  Новый ОбработкаРасшифровкиКомпоновкиДанных(
			РасшифровкаКомпановки, Новый ИсточникДоступныхНастроекКомпоновкиДанных(Параметры.АдресСхемыРасшифровки));
