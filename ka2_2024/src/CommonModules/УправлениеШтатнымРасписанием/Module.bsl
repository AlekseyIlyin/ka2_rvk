...
Функция ЗапросВТШтатноеРасписание(ТолькоРазрешенные, ПараметрыПостроения, Знач ИменаСведений = Неопределено, Знач ИмяВТШтатноеРасписание = "ВТШтатноеРасписание") Экспорт
	...
	Если ЕстьТаблицаОтборов Тогда
		...
		Если ОписаниеИсточников.ЗначенияОпций.ИспользоватьИсториюИзмененияШтатногоРасписания Тогда
			...
			Если ПараметрыПостроения.ВключаяЗакрытые Тогда
...
Процедура ДобавитьОписаниеСведенийТерриториальныхУсловийПФР(ОписаниеИсточников)
	...
	ДобавитьОписаниеСведенийШтатногоРасписания(ОписаниеИсточников, ИмяДанныхШР, ИдентификаторИсточника,
		"	ВЫБОР
		|		КОГДА РегистрСведенийТерриториальныеУсловияПФР.ТерриториальныеУсловияПФР В (ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.МКС), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.РКСР), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.МКСРКСР), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.МКСР), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.РКС), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.РКСМ), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.ОКУ), ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.ПРОЧ))
		|			ТОГДА ИСТИНА
		|		ИНАЧЕ ЛОЖЬ
		|	КОНЕЦ");
