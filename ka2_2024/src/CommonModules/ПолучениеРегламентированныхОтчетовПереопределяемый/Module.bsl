...
Процедура ПриДобавленииВидовРегламентированныхОтчетов(ВидыОтчетов, ДополнительныеПараметры) Экспорт
	...
	//++ НЕ УТ
	РегламентированнаяОтчетностьУП.ПриДобавленииВидовРегламентированныхОтчетов(ВидыОтчетов, ДополнительныеПараметры);
	//-- НЕ УТ
...
Процедура ПриЗагрузкеРегламентированногоОтчета(ОписаниеФайла, Обработан, ДополнительныеПараметры) Экспорт
	...
	//++ НЕ УТ
	РегламентированнаяОтчетностьУП.ПриЗагрузкеРегламентированногоОтчета(ОписаниеФайла, Обработан, ДополнительныеПараметры);
	//-- НЕ УТ
