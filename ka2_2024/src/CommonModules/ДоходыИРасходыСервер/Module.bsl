...
Процедура ПроверкаНераспределенныеРасходыБудущихПериодов(ПараметрыПроверки) Экспорт
	...
	//++ НЕ УТ
	СписокПолей.Добавить("СуммаНУ",		 			НСтр("ru = 'Сумма (НУ)'", ОбщегоНазначения.КодОсновногоЯзыка()));
	СписокПолей.Добавить("ПостояннаяРазница",		НСтр("ru = 'Сумма (ПР)'", ОбщегоНазначения.КодОсновногоЯзыка()));
	СписокПолей.Добавить("ВременнаяРазница",		НСтр("ru = 'Сумма (ВР)'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//-- НЕ УТ
	...
	//++ НЕ УТ
	СписокПолей.Добавить("БезСуммНУ",		 		НСтр("ru = 'Автосумма (НУ)'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//-- НЕ УТ
