...
Процедура ЗаполнитьПроизводственнуюОперациюСАТУРННаОснованииОтчетаПереработчика2_5(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ТекстТоварыДокумента = СтрЗаменить(ТекстТоварыДокумента, "ПОМЕСТИТЬ ТоварыСерии", "ПОМЕСТИТЬ ОтчетПереработчика2_5");
	ТекстТоварыДокумента = ТекстТоварыДокумента + ТекстЗапросаСырье("ОтчетПереработчика2_5");
