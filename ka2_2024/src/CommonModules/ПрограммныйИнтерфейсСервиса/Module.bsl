...
// Возвращает шаблон параметров добавления существующего пользователя для метода
...
//  Структура - шаблон параметров добавления пользователя в приложение:
//   * КодПриложения - Число - код приложения (номер области)
//   * ЧасовойПояс - Строка - новое наименование приложения
//
...
Функция РасширенияДляСопоставления(ПараметрыЗапроса,
	...
	ДанныеЗапроса.Вставить("account", АбонентЭтогоПриложения().Код);
