...
Процедура ОтразитьОперациюСебестоимостиСписаниеНаДругиеПартии(ПараметрыОтражения)
	...
	//++ НЕ УТ
	|		КОГДА ДанныеДокумента.ХозяйственнаяОперация <> ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СписаниеРасходовНаПартииПроизводства)
	|		 И ТИПЗНАЧЕНИЯ(ДанныеДокумента.Ссылка) = ТИП(Документ.ПроизводствоБезЗаказа)
