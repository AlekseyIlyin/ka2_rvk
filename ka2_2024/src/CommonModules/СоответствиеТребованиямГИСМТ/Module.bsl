...
Функция РеквизитыДокумента(Документ) Экспорт
	...
	Если Не РеквизитыДокумента.ДанныеЭлектронногоДокумента = Неопределено Тогда
		...
		ЭлектронноеВзаимодействиеИСМППереопределяемый.ЗаполнитьСведенияОбАдресахУчастниковОбмена_5_02(РеквизитыДокумента.ДанныеЭлектронногоДокумента, Документ, СтруктураАдресов);
