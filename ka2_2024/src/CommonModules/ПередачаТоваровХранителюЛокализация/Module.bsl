...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	Если Не ЭтоПартнер Тогда
		ХозяйственныеОперацииКоманды = Новый Массив;
		ХозяйственныеОперацииКоманды.Добавить(Перечисления.ХозяйственныеОперации.ПередачаНаКомиссию);
		//++ НЕ УТ
		ХозяйственныеОперацииКоманды.Добавить(Перечисления.ХозяйственныеОперации.ПередачаПереработчику2_5);
		//-- НЕ УТ
...
Функция ПолучитьДанныеДляПечатнойФормыУПД(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	|		ПО ДанныеДокументов.ИсправляемыйДокумент = РеестрДокументов.ИсправляемыйДокумент
	|			И ДанныеДокументов.Ссылка.МоментВремени >= РеестрДокументов.Ссылка.МоментВремени
	|ГДЕ
