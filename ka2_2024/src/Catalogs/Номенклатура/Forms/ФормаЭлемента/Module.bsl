...
Процедура НастроитьФормуИОбновитьКарточку()
	...
	Если Элементы.Найти("ВестиУчетПоГТД") <> Неопределено Тогда
		...
		ВидимостьГруппаПрослеживаемостьВПроизводстве = Ложь;
		//++ НЕ УТ
		ВидимостьГруппаПрослеживаемостьВПроизводстве = Элементы.ГруппаПрослеживаемостьВПроизводстве.Видимость;
		УстановитьДоступностьПрослеживаемыйТоварЛокализация(Элементы.ПрослеживаемыйТовар, Объект);
		//-- НЕ УТ
		Элементы.ГруппаПрослеживаемостьВПроизводстве.Видимость = ВидимостьГруппаПрослеживаемостьВПроизводстве;
...
Функция ЗаполнитьМультиязычноеНаименованиеПолноеПоНаименованию()
	...
	ЗначениеЯзыка.Вставить("КодЯзыка", ТекущийЯзык().КодЯзыка);
	ЗначениеЯзыка.Вставить("ЗначениеРеквизита", Объект[ИмяРеквизита]);
	ЗначениеЯзыка.Вставить("Суффикс", "");
