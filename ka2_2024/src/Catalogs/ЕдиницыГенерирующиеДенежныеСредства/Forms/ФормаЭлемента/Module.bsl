...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ВалютаУУ) Тогда
		Элементы.СтоимостьУУ.Заголовок = СтрШаблон(НСтр("ru = 'УУ(%1)'"), ВалютаУУ.Наименование);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ВалютаБУ) Тогда
		Элементы.СтоимостьБУ.Заголовок = СтрШаблон(НСтр("ru = 'БУ(%1)'"), ВалютаБУ.Наименование);
	КонецЕсли;
