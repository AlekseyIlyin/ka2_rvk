...
Процедура ИзменениеВыраженияВРедактореФормул(ИмяВыражения)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменениеВыраженияВРедактореФормулЗавершение", ЭтотОбъект,
...
Функция ПодготовитьДеревоОперандов()
	...
	ДанныеВидаАналитики = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВидАналитики,
