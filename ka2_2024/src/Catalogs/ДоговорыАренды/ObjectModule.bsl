...
Процедура ПередЗаписью(Отказ)
	...
	Если УникальныйНомерВалютногоКонтроля <> "" Тогда
		...
		ВалютныйКонтроль = ДенежныеСредстваКлиентСерверЛокализация.ПрименяетсяВалютныйКонтроль(
			КонтрагентЮрФизЛицо, ВалютаВзаиморасчетов, ВалютаРеглУчета, ОплатаВВалюте);
