		...
		Иначе
			...
			Если ЗначениеЗаполнено(ЭлементОтбора.ПравоеЗначение) Тогда
				...
				ИначеЕсли ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
					ОписаниеЭлемента.ТипСсылочногоЗначения = ТипСсылочногоЗначения(ТипЗначения);
...
Функция ТипСсылочногоЗначения(ТипЗначения)
	...
	ИначеЕсли ТипЗначения = Тип("СправочникСсылка.Должности") Тогда
		Возврат "positions";
	ИначеЕсли ТипЗначения = Тип("СправочникСсылка.СтруктураПредприятия") Тогда
		Возврат "divisions";
...
Функция УсловияВыводаОбластей(ИмяПредопределенного)
	...
	ИначеЕсли ИмяПредопределенного = "ЗаявлениеОбИзмененииЛичныхДанных" Тогда
		...
		Условия.Добавить(
			Новый Структура("ЛевоеЗначение,ВидСравнения,ПравоеЗначение",
				Новый ПолеКомпоновкиДанных("ДанныеДокумента.ИзменениеДокумента"),
				ВидСравненияКомпоновкиДанных.Равно,
				Истина));
		УсловияВывода.Вставить(ИмяОбласти, Условия);
