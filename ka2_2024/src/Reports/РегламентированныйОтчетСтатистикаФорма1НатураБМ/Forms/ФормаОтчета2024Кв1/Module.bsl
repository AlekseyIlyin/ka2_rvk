...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если СтрНайти(ОбластьСобытия.Имя, "_") = 14 Тогда
		...
		ИначеЕсли СтрНайти(Область.Имя, "П0000020001") = 1 Тогда
			СинхронизироватьРаздел("П0000020001", "П0000010001", Сред(Область.Имя, 15));
		ИначеЕсли СтрНайти(ОбластьСобытия.Имя, "П0000040001") = 1 Тогда
			СинхронизироватьРаздел("П0000040001", "П0000050001", Сред(ОбластьСобытия.Имя, 15));
		ИначеЕсли СтрНайти(ОбластьСобытия.Имя, "П0000050001") = 1 Тогда
			СинхронизироватьРаздел("П0000050001", "П0000040001", Сред(ОбластьСобытия.Имя, 15));
		КонецЕсли;
	КонецЕсли;
