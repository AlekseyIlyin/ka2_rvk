...
Процедура ОбработкаВыбораПрОбъекта(Область, СтандартнаяОбработка)
	...
	Если ЭтотОбъект["ТекущееИДНаименования"] = "Лист002" Тогда 
		Если ПрОбъекта = "организация" Тогда 
	...
	ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]].ПрОбъекта = Область.Значение;
	ПрОбъекта = Область.Значение;
	Если ПрОбъекта = "организация" Тогда 
		...
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["Фамилия"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["Имя"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["Отчество"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["КодВидДок"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["СерНомДок"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["ДатаДок"] = Неопределено;
	ИначеЕсли ПрОбъекта = "индивидуальный предприниматель" Тогда
		...
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["КПП"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["КодВидДок"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["СерНомДок"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["ДатаДок"] = Неопределено;
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]]["НаимОрг"] = Неопределено;
	ИначеЕсли ПрОбъекта = "физическое лицо" Тогда
		ПредставлениеУведомления.Области["КПП"].Значение = Неопределено;
		ПредставлениеУведомления.Области["НаимОрг"].Значение = Неопределено;
...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли СтрДлина(Область.Имя) = 7 И СтрНачинаетсяС(Область.Имя, "Код") Тогда 
		...
		ЭтотОбъект["ДанныеУведомления"][ЭтотОбъект["ТекущееИДНаименования"]][Область.Имя] = Область.Значение;
		СтандартнаяОбработка = Ложь;
		Модифицированность = Истина;
		Возврат;
	КонецЕсли;
