...
Функция ПолучитьСтавкиАкциза(ДатаДействия);
	...
	ИначеЕсли ГодПериода = 2025 Тогда
		...
		СтавкиАкцизов.Вставить("111", 669);
		СтавкиАкцизов.Вставить("121", 669);
		СтавкиАкцизов.Вставить("140", 669);
		СтавкиАкцизов.Вставить("150", 669);
		СтавкиАкцизов.Вставить("160", 669);
		СтавкиАкцизов.Вставить("166", 669);
		СтавкиАкцизов.Вставить("170", 669);
		СтавкиАкцизов.Вставить("224", 669);
		СтавкиАкцизов.Вставить("225", 669);
		СтавкиАкцизов.Вставить("226", 669);
		СтавкиАкцизов.Вставить("227", 669);
		СтавкиАкцизов.Вставить("232", 27);
		СтавкиАкцизов.Вставить("251", 37);
		СтавкиАкцизов.Вставить("252", 37);
		СтавкиАкцизов.Вставить("253", 37);
		СтавкиАкцизов.Вставить("254", 37);
		СтавкиАкцизов.Вставить("255", 37);
		СтавкиАкцизов.Вставить("256", 37);
		СтавкиАкцизов.Вставить("274", 124);
		СтавкиАкцизов.Вставить("275", 124);
		СтавкиАкцизов.Вставить("276", 112);
		СтавкиАкцизов.Вставить("277", 112);
		СтавкиАкцизов.Вставить("278", 147);
		СтавкиАкцизов.Вставить("279", 147);
		СтавкиАкцизов.Вставить("287", 37);
		СтавкиАкцизов.Вставить("288", 147);
		СтавкиАкцизов.Вставить("289", 112);
		СтавкиАкцизов.Вставить("290", 669);
		СтавкиАкцизов.Вставить("294", 32);
		СтавкиАкцизов.Вставить("298", 7);
		СтавкиАкцизов.Вставить("310", 0);
...
Процедура ПроверкаКС_08_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Серия и номер свидетельства в стр.030 Приложения 4 должены быть заполнены'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Значение не заполнено'"));
...
Процедура ПроверкаКС_10_18()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Месяц и год в стр.135 Приложения 6 должены быть заполнены'"));
