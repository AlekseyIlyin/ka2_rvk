...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭтотОбъект["ДанныеУведомления"].Форма2021_1_Титульная.Свойство("АдресXML") Тогда 
		ЭтотОбъект["ДанныеУведомления"].Форма2021_1_Титульная.Вставить("АдресXML", "");
		ЭтотОбъект["ДанныеУведомления"].Форма2021_1_Титульная.Вставить("Адрес9зпт", "");
	КонецЕсли;
	
	Если Не ЭтотОбъект["ДанныеУведомления"].Форма2021_1_Лист2.Свойство("ВыводитьНольНаПечать") Тогда 
		ЭтотОбъект["ДанныеУведомления"].Форма2021_1_Лист2.Вставить("ВыводитьНольНаПечать", Ложь);
	КонецЕсли;
