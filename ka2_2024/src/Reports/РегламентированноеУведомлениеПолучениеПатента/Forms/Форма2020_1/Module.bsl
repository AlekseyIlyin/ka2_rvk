...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Элт Из ЭтотОбъект["ДанныеМногостраничныхРазделов"].Форма2020_1_ЛистА Цикл 
		ЛистА = Элт.Значение;
	...
	КонецЦикла;
	Для Каждого Элт Из ЭтотОбъект["ДанныеМногостраничныхРазделов"].Форма2020_1_ЛистВ Цикл 
		ЛистВ = Элт.Значение;
	...
	Если Не ЭтотОбъект["ДанныеУведомления"].Форма2020_1_Титульная.Свойство("АдресXML") Тогда 
		ЭтотОбъект["ДанныеУведомления"].Форма2020_1_Титульная.Вставить("АдресXML", "");
		ЭтотОбъект["ДанныеУведомления"].Форма2020_1_Титульная.Вставить("Адрес9зпт", "");
	КонецЕсли;
	
	Если Не ЭтотОбъект["ДанныеУведомления"].Форма2020_1_Лист2.Свойство("ВыводитьНольНаПечать") Тогда 
		ЭтотОбъект["ДанныеУведомления"].Форма2020_1_Лист2.Вставить("ВыводитьНольНаПечать", Ложь);
	КонецЕсли;
...
Процедура ЗаполнитьНачальныеДанные() Экспорт
	...
	ДанныеУведомленияТитульный = ЭтотОбъект["ДанныеУведомления"]["Форма2020_1_Титульная"];
...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	Если ЭтотОбъект["ТекущийМакет"] = "Форма2020_1_Титульная" Тогда 
		...
		КонецЕсли;
	ИначеЕсли  ЭтотОбъект["ТекущийМакет"] = "Форма2020_1_Лист2" И Область.Имя = "ВыводитьНольНаПечать" Тогда 
