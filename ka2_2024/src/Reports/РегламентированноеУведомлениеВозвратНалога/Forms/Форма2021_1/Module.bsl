...
Процедура ЗаполнитьНачальныеДанные() Экспорт
	...
	СвСчБанк = ЭтотОбъект["ДанныеУведомления"]["СвСчБанк"];
...
Процедура ПоказатьТекущуюСтраницу(ИмяМакета)
	...
	Если Не ЭтотОбъект["ЭтоЮЛ"] И ЭтотОбъект["ТекущееИДНаименования"] = "Титульная" Тогда 
...
Процедура ЗагрузитьИзXMLНаСервере(ПараметрыЗагрузкиXML)
	...
	Если ЭтотОбъект["ДанныеУведомления"].СвСчБанк.ПрПолучатель = "2" Тогда 
		ЭтотОбъект["ДанныеУведомления"].СвСчБанк.Л0107 = ЭтотОбъект["ДанныеУведомления"].СвСчБанк.ФамилияПолучатель + " "
		+ ЭтотОбъект["ДанныеУведомления"].СвСчБанк.ИмяПолучатель + " " + ЭтотОбъект["ДанныеУведомления"].СвСчБанк.ОтчествоПолучатель;
	ИначеЕсли ЭтотОбъект["ДанныеУведомления"].СвСчБанк.ПрПолучатель = "3" Тогда 
		ЭтотОбъект["ДанныеУведомления"].СвСчБанк.Л0107 = ЭтотОбъект["ДанныеУведомления"].СвСчБанк.НаимОргЛицСч;
	КонецЕсли;
	ЭтотОбъект["ЭтоЮЛ"] = РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(Объект.Организация);
