...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Лист02_7А" Тогда
		...
		Для каждого Лист02_Поиск Из ДеревоДанных.Строки Цикл
			...
			Листы02_7Б = Лист02_Поиск.Строки[6].Строки;
			
			Листы02_7Б_Стр040 = Листы02_7Б_Стр040 + РегламентированнаяОтчетностьКлиентСервер.СуммаПоказателяПоВеткам(
				Форма, Листы02_7Б, "П0027Б0004003");
			
			Листы02_7В = Лист02_Поиск.Строки[7].Строки;
		...
		Для каждого Лист02 Из ДеревоДанных.Строки Цикл
			...
			Для каждого Лист02_7А Из Листы02_7А Цикл
				...
				Если ЗначениеЗаполнено(Данные["ПризнакВключения"]) Тогда
					...
					// Стр.030 (зависит от объекта составления расчета) = Стр.040 Раздела Б ИЛИ Сумма стр.040 Разделов В.
					//
				...
				Если ЗначениеЗаполнено(Данные["ПризнакВключения"]) Тогда
					...
					Если ЗначениеЗаполнено(РС) И ЗначениеЗаполнено(КПП) Тогда
						...
						Для каждого Лист02_Поиск Из ДеревоДанных.Строки Цикл
							...
							Листы02_5_Стр050 = Листы02_5_Стр050 + РегламентированнаяОтчетностьКлиентСервер.СуммаПоказателяПоВеткам(
								Форма, Листы02_5, "П000250005003", Усл);
							Листы02_5_Стр070 = Листы02_5_Стр070 + РегламентированнаяОтчетностьКлиентСервер.СуммаПоказателяПоВеткам(
