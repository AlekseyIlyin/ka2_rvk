...
Процедура ВосстановитьСохраненныеДанные()
	...
	ОбъектОтчета(ИмяФормы).ОчиститьПриложения4КЛисту02НеВключенныеВСоставОтчета(СтруктураРеквизитовФормы);
...
Процедура СформироватьРаздел1_1()
	...
	ОбъектОтчета(ИмяФормы).СформироватьРаздел1_1(ЭтаФорма, СтруктураДанныхТитульный, ТабличныйДокумент);
...
Процедура СформироватьРаздел1_2()
	...
	ОбъектОтчета(ИмяФормы).СформироватьРаздел1_2(ЭтаФорма, СтруктураДанныхТитульный, ТабличныйДокумент);
