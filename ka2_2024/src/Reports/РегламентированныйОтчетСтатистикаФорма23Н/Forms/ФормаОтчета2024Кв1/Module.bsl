...
Процедура ДополнитьРеквизитыФормы()
	...
	Для Каждого Стр Из КатегорииКлассификатора Цикл
		...
		Если Стр = "П0010010001" Тогда
			...
			Для Гр = 1 По 11 Цикл
				Если Гр = 1 Или Гр = 2 Или Гр = 3
				 Или Гр = 5 Или Гр = 6 Или Гр = 7 Тогда
				...
				ИначеЕсли Гр >= 8 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(14, 3));
				КонецЕсли;
		...
		ИначеЕсли Стр = "П0030010002" Тогда
			...
			ТипКолонкиЧисло  = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(14, 3));
