...
Функция ЭлектронноеПредставление(Объект, ИмяФормы, УникальныйИдентификатор) Экспорт
	Если ИмяФормы = "ОсвобождениеОтУплатыНДС_501" Или ИмяФормы = "ФормаОсвобождениеНДС" Тогда
		Возврат ЭлектронноеПредставление_ОсвобождениеОтУплатыНДС_501(Объект, УникальныйИдентификатор);
	ИначеЕсли ИмяФормы = "ОсвобождениеОтУплатыНДС_502" Тогда
...
Функция СформироватьСписокЛистов_ОсвобождениеОтУплатыНДС_501(Объект) Экспорт
	...
	Для Каждого Обл Из ПечатнаяФорма.Области Цикл 
		Если Обл.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник И обл.СодержитЗначение = Истина Тогда 
			ДанныеУведомления.Титульная.Свойство(Обл.Имя, Обл.Значение);
		КонецЕсли;
	КонецЦикла;
...
Функция ПроверитьДокументСВыводомВТаблицу(Объект, ИмяФормы, УникальныйИдентификатор) Экспорт 
	Если ИмяФормы = "ОсвобождениеОтУплатыНДС_501" Или ИмяФормы = "ФормаОсвобождениеНДС" Тогда 
		Возврат ПроверитьДокументСВыводомВТаблицу_ОсвобождениеОтУплатыНДС_501(
...
Функция ПроверитьДокументСВыводомВТаблицу_ОсвобождениеОтНДСПриЕСХН_502(Данные, УникальныйИдентификатор)
	...
	КонецЕсли;
	УведомлениеОСпецрежимахНалогообложенияСлужебный.ПроверкаГода(Титульная, ТаблицаОшибок, "Титульная", "Год", Истина,, 2024);
...
Функция ПроверитьДокументСВыводомВТаблицу_ОсвобождениеОтУплатыНДС_502(Данные, УникальныйИдентификатор)
		...
		Если УведомлениеОСпецрежимахНалогообложения.СтраницаЗаполнена(Данные.ДанныеУведомления.СовВыр3Месяца) Тогда 
			Для Инд = 1 По 3 Цикл 
				УведомлениеОСпецрежимахНалогообложенияСлужебный.ПроверкаГода(
					СовВыр3Месяца, ТаблицаОшибок, "СовВыр3Месяца", "СовВыр3МесяцаГод" + Инд, Истина, Неопределено, 2024);
	...
	Если УведомлениеОСпецрежимахНалогообложения.СтраницаЗаполнена(Данные.ДанныеУведомления.Выр12Месяцев) Тогда 
		...
		Для Инд = 1 По 12 Цикл 
			УведомлениеОСпецрежимахНалогообложенияСлужебный.ПроверкаГода(
				Выр12Месяцев, ТаблицаОшибок, "Выр12Месяцев", "Выр12МесяцевГод" + Инд, Истина, Неопределено, 2024);
...
Функция ЭлектронноеПредставление_ОсвобождениеОтУплатыНДС_501(Объект, УникальныйИдентификатор)
	...
	СтруктураВыгрузки = Документы.УведомлениеОСпецрежимахНалогообложения.ИзвлечьСтруктуруXMLУведомления(
		Объект.ИмяОтчета, "СхемаВыгрузки_ОсвобождениеОтУплатыНДС501");
