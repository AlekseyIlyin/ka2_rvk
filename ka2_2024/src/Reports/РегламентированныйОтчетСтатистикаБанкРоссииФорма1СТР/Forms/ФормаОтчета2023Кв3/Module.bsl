...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел511", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"]);
	Контейнер.Вставить("Раздел512", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"]);
	Контейнер.Вставить("Раздел521", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"]);
	Контейнер.Вставить("Раздел522", СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"]);
	...
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел511"] = Контейнер["Раздел511"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел512"] = Контейнер["Раздел512"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел521"] = Контейнер["Раздел521"];
	СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел522"] = Контейнер["Раздел522"];
