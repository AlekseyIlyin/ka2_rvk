...
Процедура ДеревоСтраницПриАктивизацииСтрокиЗавершение() Экспорт 
	...
	Иначе 
		...
		Если Элемент.ТекущиеДанные.Многострочность Тогда
			Если ЭтотОбъект["ТекущееИДНаименования"] = "ЛистН1" Тогда 
				ВывестиМногострочнуюЧасть("МногострочнаяЧасть1");
			ИначеЕсли ЭтотОбъект["ТекущееИДНаименования"] = "ЛистН2" Тогда
...
Процедура ПредставлениеУведомленияПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(Область.Имя, "А01020000_") И СтрНачинаетсяС(ЭтотОбъект["ТекущееИДНаименования"], "ЛистН") Тогда 
		Постфикс = Число(СтрЗаменить(Область.Имя, "А01020000_", ""));
		МногострочнаяЧасть = ?(ЭтотОбъект["ТекущееИДНаименования"] = "ЛистН1", МногострочнаяЧасть1, МногострочнаяЧасть2);
...
Функция ЭтоОбластьОКСМ(Область)
	Если (Область.Имя = "В0503050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистВ2_4")
		Или (Область.Имя = "В05040401" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистВ2_4")
		Или (Область.Имя = "Г02020000" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистГ1_2")
		Или (Область.Имя = "Г03020100" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистГ1_2")
		Или (Область.Имя = "Г0503050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистГ3_5")
		Или (Область.Имя = "Г05040401" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистГ3_5") 
		Или (Область.Имя = "Д03060201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистД")
		Или (Область.Имя = "Д06060201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистД")
		Или (Область.Имя = "Д0702050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистД")
		Или (Область.Имя = "Д0503050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистД3_5")
		Или (Область.Имя = "Д05040401" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистД3_5")
		Или (Область.Имя = "Е040203050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЕ3_4")
		Или (Область.Имя = "Е0503050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЕ5_7")
		Или (Область.Имя = "Е05040401" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЕ5_7")
		Или (Область.Имя = "Ж0503050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЖ3_5")
		Или (Область.Имя = "Ж05040401" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЖ3_5")
		Или (Область.Имя = "К03060201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистК")
		Или (Область.Имя = "Л05010000" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЛ")
		Или (Область.Имя = "Л09050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистЛ")
		Или (Область.Имя = "О03020201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистО")
		Или (Область.Имя = "О04020100" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистО")
		Или (Область.Имя = "Р04050201" И ЭтотОбъект["ТекущееИДНаименования"] = "ЛистР") Тогда
