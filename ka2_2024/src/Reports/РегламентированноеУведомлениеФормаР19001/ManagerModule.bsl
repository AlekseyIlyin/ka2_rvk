...
Функция ПолучитьТаблицуФорм() Экспорт
	...
	ПолноеОписаниеФормы.ОписаниеФормы = "В редакции приказа ФНС России от 24.07.2023 № ЕД-7-14/493@";
	ПолноеОписаниеФормы.ДатаНачала = '2020-11-25';
	ПолноеОписаниеФормы.ДатаКонца  = '2024-11-30';
	
	Если ТекущаяДатаСеанса() > '20241201' Или ДокументооборотСКОВызовСервера.ИспользуетсяРежимТестирования() Тогда 
		ПолноеОписаниеФормы = Результат.Добавить();
