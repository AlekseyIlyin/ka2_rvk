...
Процедура СохранитьПолныйКодМаркировкиПриВскрытииПотребительскойУпаковки()
	...
	Если Не СохранитьПолныйКод
		Или Не ОбщегоНазначенияИСКлиент.ЭтоРасширеннаяВерсияГосИС() Тогда
		Возврат;
	КонецЕсли;
...
Процедура СкладПриИзмененииНаСервере()
	...
	Если ОбщегоНазначенияИС.ЭтоРасширеннаяВерсияГосИС()
...
Функция ОбработатьШтрихкодКодаМаркировки(ДанныеШтрихкода)
	...
	Если ЭтоРедактированиеЗаписи Тогда
		...
		КонецЕсли;
		Возврат Ложь;
	ИначеЕсли ОбщегоНазначенияИСКлиент.ЭтоРасширеннаяВерсияГосИС() Тогда
