...
Процедура СохранитьСпособАвторизации(Организация, СпособАвторизации) Экспорт
	...
	Если Не МенеджерЗаписи.Выбран() Тогда
		МенеджерЗаписи.Организация = Организация;
	КонецЕсли;
	МенеджерЗаписи.СпособАвторизации = СпособАвторизации;
	МенеджерЗаписи.Записать();
...
Функция ПолучитьСпособАвторизацииСЕНС(Организация) Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	МенеджерЗаписи = РегистрыСведений.СостоянияПодключенияЕНС.СоздатьМенеджерЗаписи();
	МенеджерЗаписи.Организация = Организация;
	МенеджерЗаписи.Прочитать();
	СпособАвторизацииСЕНС = МенеджерЗаписи.СпособАвторизации;
	УстановитьПривилегированныйРежим(Ложь);
	
	Возврат СпособАвторизацииСЕНС;
