...
Процедура ОтправитьУведомления(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		ИначеЕсли ТекущиеДанные.НеОтправляетсяВКонтролирующийОрган
			...
			ИЛИ ТекущиеДанныеНаименованиеОтчета = "Уведомление о приостановлении (возобновлении) применения пониженных тарифов страховых взносов"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("приостановлении (возобнов")
			...
			ИЛИ ТекущиеДанныеНаименованиеОтчета =
					"Уведомление о выборе налогового органа, в который представляется налоговая декларация по туристическому налогу"
				И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("туристическому налогу", Истина) Тогда
		...
		Если ВидПечати = "ПечатьОтчет" Тогда
			...
			ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
				...
				ИначеЕсли ОписаниеОтчета.ИсточникОтчета = "РегламентированныйОтчетФинОтчетностьМГК"
				          И ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2025Кв1"
				          ИЛИ ОписаниеОтчета.ИсточникОтчета = "РегламентированныйОтчетБухОтчетность"
