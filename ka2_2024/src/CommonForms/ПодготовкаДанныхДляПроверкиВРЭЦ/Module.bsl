...
Процедура ПроверитьВРЭЦ(Команда)        
	...
	Иначе
		Отпечаток = ДокументооборотСРЭЦВызовСервера.ЗначениеРеквизитаОбъекта(Организация, "УчетнаяЗаписьОбмена.СертификатРуководителя", Истина);
...
Процедура Настройки(Команда)
	...
	//		Организация, "УчетнаяЗаписьОбмена.СертификатРуководителя");   
	Отпечаток = ДокументооборотСРЭЦВызовСервера.ЗначениеРеквизитаОбъекта(Организация, "УчетнаяЗаписьОбмена.СертификатРуководителя", Истина);
