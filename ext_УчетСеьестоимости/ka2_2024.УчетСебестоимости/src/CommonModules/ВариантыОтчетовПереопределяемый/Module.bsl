...
Процедура усНастроитьВариантыОтчетов(Настройки) Экспорт
...
//	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.ИмяРаздела.Подсистемы.ИмяПодсистемы);
	...
	МетаданныеОтчетПродажиИСебестоимость = Метаданные.Отчеты.усПродажиИСебестоимость; 

	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, МетаданныеОтчетПродажиИСебестоимость, "ПоНоменклатуре");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Продажи);
	НастройкиВарианта.Описание = НСтр("ru = 'Продажи с себестоимостью по номенклатуре.'");
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, МетаданныеОтчетПродажиИСебестоимость, "ПоТП");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Продажи);
	НастройкиВарианта.Описание = НСтр("ru = 'Продажи с себестоимостью по Торговым представителям.'");
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, МетаданныеОтчетПродажиИСебестоимость, "ПоПроизводителям");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Продажи);
	НастройкиВарианта.Описание = НСтр("ru = 'Продажи с себестоимостью по производителям.'");

	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, МетаданныеОтчетПродажиИСебестоимость, "ОбъемПродаж");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Продажи);
	ОписаниеВарианта.Описание = НСтр("ru = 'Продажи: количество, себестоимость и выручка по производителям и покупателям.'");
	
	
	МетаданныеОтчетДистрибьюцияПоТП = Метаданные.Отчеты.усДистрибьюцияПоТП; 

	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, МетаданныеОтчетДистрибьюцияПоТП, "Основной");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Продажи);
	НастройкиВарианта.Описание = НСтр("ru = 'Дистрибьюция по Торговым представителям.'");
