...
Процедура КомандаВыбрать(Команда)
	...
	СтррРезультат = Новый Структура("Цвет,ПредставлениеЦвета", Новый Цвет(Красный, Зеленый, Синий), СокрЛП(ПредставлениеЦвета));
...
&НаКлиентеНаСервереБезКонтекста 
Функция КонтрастныйЦвет(Red, Green, Blue)
