...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Контроль заполнения справочних данных");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Дополнительный отчет 'Контроль заполнения справочних данных'");
    ...
    ДобавитьКоманду(ТаблицаКоманд, "Контроль заполнения справочних данных", "ФормаОтчета", "ОткрытиеФормы", Ложь, "ПечатьMXL");
