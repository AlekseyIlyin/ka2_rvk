...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "'Прайс-лист внешний с картинкой");
    ...
    ПараметрыРегистрации.Вставить("Информация", "Дополнительный отчет 'Прайс-лист внешний с картинкой'");
    ...
    ДобавитьКоманду(ТаблицаКоманд, "Прайс-лист внешний с картинкой", "ФормаОтчета", "ОткрытиеФормы", Ложь, "ПечатьMXL");
